...
class WallpapersControllerTest < ActionController::TestCase
  ...
  test "should create wallpaper" do
    assert_difference('Wallpaper.count') do
      post :create, wallpaper: { description: @wallpaper.description, name: @wallpaper.name, picture: @wallpaper.picture }
    end
  ...
  test "should update wallpaper" do
    patch :update, id: @wallpaper, wallpaper: { description: @wallpaper.description, name: @wallpaper.name, picture: @wallpaper.picture }
    assert_redirected_to wallpaper_path(assigns(:wallpaper))
  end
